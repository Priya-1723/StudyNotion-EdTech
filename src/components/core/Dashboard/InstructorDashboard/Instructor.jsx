...
const Instructor = () => {
    ...
    useEffect(() => {
        const getCourseDataWithStats = async () => {
            ...
            console.log("Instructor Courses API Data:", result); 
            ...
            console.log("Passing courses to InstructorChart:", instructorApiData?.courses);
        }
    ...
    const totalAmount = instructorData?.totalAmount 
    ...
    // console.log("Courses before passing to InstructorChart:", courses);
  ...
  return (
    <div className='text-white'>
...

        {
            ...
            : courses.length > 0 ? (
                <div>
                    <div className="my-4 flex h-[700px] space-x-4">
                        {/* Render chart / graph */}
                        {
