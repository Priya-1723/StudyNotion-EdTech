  ...
  return (
    <div className=" box-content bg-richblack-800 px-4">
        ...
        <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
            ...
            {/* section 1 */}
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                <div className="section_heading text-3xl text-richblack-5 font-semibold">Courses to get you started</div>
            ...
            {/* section 2 */}
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                <p className="section_heading text-3xl text-richblack-5 font-semibold">
            ...
            {/* section 3 */}
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                <p className="section_heading text-3xl text-richblack-5 font-semibold">Frequently Bought</p>
                <div className="py-8">
